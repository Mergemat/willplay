...
function TabsTrigger({
  ...
  return (
    ...
    >
      ...
      {isActive && (
        <motion.div
          className="absolute inset-0 rounded-md border bg-background shadow-sm dark:border-input"
