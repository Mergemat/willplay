...
function TabsTrigger({
  ...
  return (
    <Trigger
      {...props}
      className={cn(
        "group relative z-20 inline-flex h-[calc(100%-1px)] flex-1 cursor-pointer items-center justify-center whitespace-nowrap px-2 py-1 font-medium text-foreground text-sm transition-[color,box-shadow] focus-visible:border-ring focus-visible:outline-1 focus-visible:outline-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 dark:text-muted-foreground [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
